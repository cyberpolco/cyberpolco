...
describe("isRouteAllowed", () => {
  ...
  it("restricts inquiries to super_admin, hr_recruiter, technician, and teacher", () => {
    expect(rolesAllowedFor("/admin/inquiries")).toEqual(["super_admin", "hr_recruiter", "technician", "teacher"]);
  });
