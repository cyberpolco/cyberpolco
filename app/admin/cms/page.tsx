...
import { FileStack, PanelBottom, Settings } from "lucide-react";
import { requireRole } from "@/lib/auth/rbac";

// Services, Team, and Achievements are reachable from the Pages hub
// (app/admin/cms/pages/page.tsx) instead of as their own top-level cards
// here — their URLs are unchanged, this is purely where they're linked from.
const sections = [
  {
    href: "/admin/cms/pages",
    label: "Pages",
    description: "Edit the copy on Home, About, Services, Careers, and Contact — plus manage Services, Team, and Achievements.",
    icon: FileStack,
  },
  {
