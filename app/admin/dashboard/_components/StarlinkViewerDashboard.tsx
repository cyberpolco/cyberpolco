...
import { STARLINK_OPTION_LABELS, type SubscriptionPricingCents } from "@/lib/content/starlink-options";
...
export default function StarlinkViewerDashboard({
  client,
  pricing,
}: {
  client: StarlinkClient | undefined;
    ...
    <div>
      ...
      <div className="mt-8 grid gap-5 sm:grid-cols-2">
        {client.sites.map((site) => {
          const priceCents = pricing[site.subscriptionType];
